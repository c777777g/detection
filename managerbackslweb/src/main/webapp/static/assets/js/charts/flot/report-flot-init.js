...
var InitiateFlotSelectableChart2 = function () {
    return {
        init: function () {
            var data = [{
                label: "人体感应",
            ...
            var placeholder = $("#selectable-chart2");
...
var InitiateFlotSelectableChart3 = function () {
    return {
        init: function () {

            var data = [{
                label: "照明亮度",
                data: illuminating_brightness,
                color: themesecondary
            },
                {
                    label: "环境光度",
                    data: optical_inductor,
                    color: themeprimary
                }
            ];
            ...
            var placeholder = $("#selectable-chart3");
...
var InitiateFlotSelectableChart4 = function () {
    return {
        init: function () {
            ...
            var placeholder = $("#selectable-chart4");
...
var InitiateStackedChart2 = function () {
    return {
        init: function () {
            var data1 = [
                {
...
var InitiateStackedChart3 = function () {
    return {
        init: function () {
            var data1 = [
                {
...
var InitiateStackedChart4 = function () {
    return {
        init: function () {
            var data1 = [
                {
