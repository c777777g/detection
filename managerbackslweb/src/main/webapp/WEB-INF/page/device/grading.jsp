        ...
        <div class="page-sidebar" id="sidebar">
            ...
            <ul class="nav sidebar-menu">
                ...
                <li>
                    ...
                    <a href="javascript:pageTo('menu-icon ','${menu.deviceId }','${ctx }/deviceMgt/show.do?deviceId=${menu.deviceId} ')">
                            <%--<span class="menu-text">(${menu.deviceId})</span>--%>
...
<script type="text/javascript">
    ...
    function beforePage(){
        if(parseInt(currentPage) > 1){
            ...
            console.log('${ctx }' + "/deviceMgt/list.do?page="+parseInt(currentPage) - 1);

            window.location.href='${ctx }' + "/deviceMgt/list.do?page="+(parseInt(currentPage) - 1)
    ...
    $(document).ready(function () {
        ...
        if(deviceId !="null" && deviceId !="" && deviceId !=undefined && deviceId != null ){
            pageTo('menu-icon ',deviceId,'${ctx }/deviceMgt/show.do?deviceId='+deviceId)
        }
