...
<div style="width: 500px;height: 80px;line-height: 80px;font-family: SimHei;text-align: center;
    font-size: 30px;margin: 0 auto;margin-top: 20px;margin-left:20px;position: relative; color: #fff;">欢迎使用SPOT后台管理</div>

<div style="width: 300px;height: 20px;line-height: 20px;text-align: center;
    font-size: 15px;margin: 0 auto;margin-top: 0px;margin-left:25px;position: relative; color: #fff;">联系管理人员获取使用权限</div>

<div style="width: 500px;height: 80px;line-height: 80px;font-family: STXinwei;text-align: center;
    font-size: 40px;margin: 0 auto;margin-top: 150px;position: relative; color: #fff;">SPOT后台管理</div>
...
<div style="text-align: center; color:#fff;">建议使用谷歌浏览器(chrome)访问管理平台,若使用其他浏览器访问可能存在兼容性问题,影响您的使用体验。</div>
